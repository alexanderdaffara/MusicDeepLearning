...
(mpLSTM, loss_function, optimizer) = MyLSTM.prepareLSTM(12, 512, 12, isSoftMax=True)
(mrLSTM, loss_function, optimizer) = MyLSTM.prepareLSTM(2, 512, 2)
...
for i in range(len(pitch_data)):
    ...
    MyLSTM.trainLSTM(mrDim, mrLSTM, loss_function, optimizer, rhythm_data[i], 5)
